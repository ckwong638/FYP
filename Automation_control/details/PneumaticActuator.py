...
def createScene(rootNode):
    ...
    rootNode.addObject('RequiredPlugin',
                       pluginName='SoftRobots SofaPython3 SoftRobots.Inverse SofaConstraint SofaDeformable SofaEngine SofaImplicitOdeSolver SofaLoader SofaOpenglVisual SofaSimpleFem SofaSparseSolver')
    ...
    rootNode.addObject(FingerController(name="MyFingerController"))
